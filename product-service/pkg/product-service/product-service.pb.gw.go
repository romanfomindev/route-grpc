...
func RegisterProductServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ProductServiceServer) error {
	...
	mux.Handle("POST", pattern_ProductService_CreateProduct_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/romanfomindev.route_grpc.product_service.v1.ProductService/CreateProduct", runtime.WithHTTPPathPattern("/romanfomindev.route_grpc.product_service.v1.ProductService/CreateProduct"))
		if err != nil {
...
func RegisterProductServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ProductServiceClient) error {
	...
	mux.Handle("POST", pattern_ProductService_CreateProduct_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/romanfomindev.route_grpc.product_service.v1.ProductService/CreateProduct", runtime.WithHTTPPathPattern("/romanfomindev.route_grpc.product_service.v1.ProductService/CreateProduct"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_ProductService_CreateProduct_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"romanfomindev.route_grpc.product_service.v1.ProductService", "CreateProduct"}, ""))
)
