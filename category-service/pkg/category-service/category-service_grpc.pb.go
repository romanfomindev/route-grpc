...
func (c *categoryServiceClient) GetCategoryById(ctx context.Context, in *GetCategoryByIdRequest, opts ...grpc.CallOption) (*GetCategoryByIdResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/romanfomindev.route_grpc.category_service.v1.CategoryService/GetCategoryById", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CategoryService_GetCategoryById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/romanfomindev.route_grpc.category_service.v1.CategoryService/GetCategoryById",
	}
...
var CategoryService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "romanfomindev.route_grpc.category_service.v1.CategoryService",
