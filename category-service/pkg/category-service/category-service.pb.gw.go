...
func RegisterCategoryServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server CategoryServiceServer) error {
	...
	mux.Handle("POST", pattern_CategoryService_GetCategoryById_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/romanfomindev.route_grpc.category_service.v1.CategoryService/GetCategoryById", runtime.WithHTTPPathPattern("/romanfomindev.route_grpc.category_service.v1.CategoryService/GetCategoryById"))
		if err != nil {
...
func RegisterCategoryServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client CategoryServiceClient) error {
	...
	mux.Handle("POST", pattern_CategoryService_GetCategoryById_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/romanfomindev.route_grpc.category_service.v1.CategoryService/GetCategoryById", runtime.WithHTTPPathPattern("/romanfomindev.route_grpc.category_service.v1.CategoryService/GetCategoryById"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_CategoryService_GetCategoryById_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"romanfomindev.route_grpc.category_service.v1.CategoryService", "GetCategoryById"}, ""))
)
